...
RSpec.describe User, type: :model do
  ...
  let(:post1) { Post.create(author:, title: 'Hello one', text: 'This is my first post') }
  let(:post2) { Post.create(author:, title: 'Hello two', text: 'This is my second post') }
  let(:post3) { Post.create(author:, title: 'Hello three', text: 'This is my third post') }
