...
RSpec.describe Post, type: :model do
  ...
  let(:comment1) { Comment.create(post:, author:, text: 'Hi 1 Tom!') }
  let(:comment2) { Comment.create(post:, author:, text: 'Hi 2 Tom!') }
  let(:comment3) { Comment.create(post:, author:, text: 'Hi 3 Tom!') }
  let(:comment4) { Comment.create(post:, author:, text: 'Hi 4 Tom!') }
